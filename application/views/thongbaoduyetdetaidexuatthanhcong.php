...
<head>
	<meta charset="UTF-8">
	<title>Duyệt đề tài đề xuất thành công</title>
...
<body>
	...
	<h2 class="text-xs-center">Đề tài đã được duyệt</h2>
	<div class="text-xs-center">
		<a class="btn btn-info" href="http://localhost:3000/showData_controller">Quay lại</a>
	</div>
</body>
</html>