...
<head>
	<meta charset="UTF-8">
	<title>Không tìm thấy sinh viên</title>
...
<body>
	...
	<h2 class="text-xs-center">Không tìm thấy sinh viên</h2>
	<div class="container text-xs-center">
		<a href="http://localhost:3000/xoasv_controller"  class="btn btn-info">Quay lại</a>
	</div>
</body>
</html>