...
<head>
	<meta charset="UTF-8">
	<title>Tìm kiếm sinh viên cần xoá</title>
...
<body>
	...
	<!-- <div class="container">
		<h3 class="text" style="color:#286B81;text-transform:uppercase; font-weight:bold; ">Xoá sinh viên</h3>
	</div> -->
		...
		<div class="container">
			<div class="row">
				<div class="col-sm-8 push-sm-2">
					<form action="http://localhost:3000/xoasv_controller/delete" method="post" enctype="multidata/form-data">
						<div class="card">
						<div class="card-block">
 							<fieldset class="form-group">
								<label for="formGroupExampleInput2">Mã số sinh viên: </label>
								<input name="mssv" type="text" class="form-control" id="formGroupExampleInput2" autocomplete="off">
							</fieldset>
