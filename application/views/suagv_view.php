...
<head>
	<meta charset="UTF-8">
	<title>Tìm kiếm giảng viên cần sửa</title>
		...
		<div class="container">
			<div class="row">
				<div class="col-sm-8 push-sm-2">
					<form action="http://localhost:3000/suagv_controller/edit" method="post" enctype="multidata/form-data">
						<div class="card">
						<div class="card-block">
 							<fieldset class="form-group">
								<label for="formGroupExampleInput2">Mã số giảng viên: </label>
								<input name="lecturer_id" type="text" class="form-control" id="formGroupExampleInput2" autocomplete="off">
							</fieldset>
