<link rel="stylesheet" href="http://localhost:3000/start_css.css"><!DOCTYPE html>
<html lang="en">
<head>
	<meta charset="UTF-8">
	<title>Đã có giảng viên có mã số này</title>
...
<body>
	...
	<h2 class="text-xs-center">Đã có giảng viên có mã số này!</h2>
	<div class="container text-xs-center">
		<a href="http://localhost:3000/themgv_controller"  class="btn btn-info">Quay lại</a>
	</div>
</body>
</html>