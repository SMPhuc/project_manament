...
<head>
	<meta charset="UTF-8">
	<title>Thông báo sửa thành công</title>
...
<body>
	...
	<h2 class="text-xs-center">Bạn đã sửa thành công</h2>
	<div class="container text-xs-center">
		<a href="http://localhost:3000/showData_controller"  class="btn btn-info">Quay lại</a>
	</div>
</body>
</html>