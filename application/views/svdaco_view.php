...
<head>
	<meta charset="UTF-8">
	<title>Đã có sinh viên có mã số này</title>
...
<body>
	...
	<h2 class="text-xs-center">Đã có sinh viên có mã số này!</h2>
	<div class="container text-xs-center">
		<a href="http://localhost:3000/themsv_controller"  class="btn btn-info">Quay lại</a>
	</div>
</body>
</html>