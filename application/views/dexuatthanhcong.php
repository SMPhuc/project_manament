...
<body>
	...
	<h2 class="text-xs-center">Đề tài của bạn đã được thêm vào danh sách đề tài đề xuất</h2>
	<div class="text-xs-center">
	<a href="http://localhost:3000/dexuatdetai_controller/"  class="btn btn-info">Quay lại</a>
	</div>
</body>
</html>