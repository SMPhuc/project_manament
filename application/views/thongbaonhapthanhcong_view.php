...
<body>
	...
	<h2 class="text-xs-center">Bạn đã thêm thông tin sinh viên thành công</h2>
	<div class="container text-xs-center">
		<a href="http://localhost:3000/StudentManagement_Controller"  class="btn btn-info">Quay lại</a>
	</div>
</body>
</html>