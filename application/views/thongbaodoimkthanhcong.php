...
<head>
	<meta charset="UTF-8">
	<title>Sửa mật khẩu thành công</title>
...
<body>
	...
	<h2 class="text-xs-center">Bạn đã đổi mật khẩu thành công</h2>
	<div class="text-xs-center">
	<a href="http://localhost:3000/doimk_controller"  class="btn btn-info">Quay lại</a>
	</div>
</body>
</html>