...
<body>
	...
	<h2 class="text-xs-center">Bạn chưa điền đầy đủ thông tin</h2>
	<div class="container text-xs-center">
		<a href="http://localhost:3000/dexuatdetai_controller"  class="btn btn-info">Nhập lại</a>
	</div>
</body>
</html>